FROM rustlang/rust:nightly-slim@sha256:92d97e3ddffc93a9af3e4813df6c429809f904949526732f63c4b0e470c1028a AS chef
WORKDIR /app
...
FROM node:trixie-slim@sha256:04190ed2dee64158e96dd16bc6073fe6502eb3bc14be680b3e7463d048c797eb AS runtime
WORKDIR /app
SHELL ["/bin/bash", "-euo", "pipefail", "-c"]
